...
words = ["banana", "apple", "strawberry", "blueberry", "raspberry", "orange", "cherry", "grapes", "passionfruit", "watermelon", "tangerine", "avocado", "peach", "jackfruit", "blackberry", "plum", "pineapple", "papaya", "guava","mango","pomegranite"]
